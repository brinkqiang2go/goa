...
func (*LoginRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{0}
}
...
func (*LoginResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{1}
}
...
func (*EchoerStreamingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{2}
}
...
func (*EchoerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{3}
}
...
func (*ListenerStreamingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{4}
}
...
func (*ListenerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{5}
}
...
func (*SummaryStreamingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{6}
}
...
func (*ChatSummaryCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{7}
}
...
func (*ChatSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{8}
}
...
func (*HistoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{9}
}
...
func (*HistoryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_chatter_dd8dae82ae4a5abb, []int{10}
}
...
func init() { proto.RegisterFile("chatter.proto", fileDescriptor_chatter_dd8dae82ae4a5abb) }

var fileDescriptor_chatter_dd8dae82ae4a5abb = []byte{
	// 369 bytes of a gzipped FileDescriptorProto
	,
}
